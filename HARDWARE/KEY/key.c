...
{	 
	...
	if(mode)key_up=1;  							//mode=1,支持连按
	if(key_up && (KEY1==0||KEY2==0||KEY3==0))
	{
		delay_ms(10);					//去抖动 
		key_up=0;
		if(KEY1==0)return 1;						//按键1按下，返回1
		else if(KEY2==0)return 2;			//按键2按下，返回2			
		else if(KEY3==0)return 3;			//按键3按下，返回3			
	}
	else if(KEY1==1&&KEY2==1&&KEY3==1)key_up=1;		//没有按键按下，松开标志位置1	
	return 0;								// 无按键按下.返回0
}
